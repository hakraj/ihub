...
const ProductPage = () => {
  ...
  return (
    <main>
      <div>
        <div className="relative w-full h-[256px] mb-8 lg:mb-16">
          <Image className="h-full w-full object-cover" src="/product/quote.jpg" alt="qoute-tet-img" priority height={1000} width={1000} />
        ...
        <div className="px-6 md:px-8 mb-24">
          <div>
        ...
        {isVisible &&
          <div className="px-6 md:px-8 pb-4 w-full bg-white fixed bottom-0">
