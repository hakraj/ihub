      ...
      <div className="lg:grid lg:px-[10%] lg:pt-16 grid-cols-2 lg:gap-8">
        <div>
          <div className="relative w-full h-[256px] lg:h-[384px] mb-8 lg:mb-16">
            <img className="h-full w-full object-cover lg:rounded-lg" src={`https://res.cloudinary.com/dj55g1hdn/image/upload/v1715035177/tinified-min/${prod[0].id}-min.jpg`} alt={`product-${prod[0].id}-img`} fetchPriority="high" />
