  ...
  return (
    <div className="py-4 my-16">
      <div className="w-full flex items-center justify-between mb-4">
        ...
        <div>
          <Link href={`/shop?category=${category}`}><button className="block w-full py-[2px] md:py-1 px-2 md:px-4 text-center text-sm lg:text-base border border-black active:shadow rounded-2xl">see more</button></Link>
        </div>
      </div>
