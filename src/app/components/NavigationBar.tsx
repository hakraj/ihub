  ...
  return (
    <>
      {isMobile ?
        ...
        :
        <div>
          <div className="pt-4 px-8 w-full flex items-center justify-between">
            ...
            <div className="flex gap-4 items-center justify-between">
              ...
              <div>
                <span className="cursor-pointer text-gray-600 hover:text-black">explore</span>
                <div className={`w-1/2 hover:w-full mx-auto h-[2px] ${styles.animateGradient}`} ></div>
              </div>
              <div>
                <span className="cursor-pointer text-gray-600 hover:text-black">shop</span>
                <div className={`w-1/2 hover:w-full mx-auto h-[2px] ${styles.animateGradient}`} ></div>
              </div>
              <div>
                <span className="cursor-pointer text-gray-600 hover:text-black">contact</span>
                <div className={`w-1/2 hover:w-full mx-auto h-[2px] ${styles.animateGradient}`} ></div>
              </div>
            </div>
