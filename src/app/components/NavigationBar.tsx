    ...
    <>
      {isMobile ?
        <div className="text-center">
          {isDropdown &&
            <div className=" absolute top-0 right-0 w-[100vw] h-[100vh] bg-black/75 z-[1000]">
              <div className=" absolute top-0 left-0 w-[75vw] h-[100vh] bg-white ">
                <div className="py-4 px-4 md:px-6  flex items-center justify-between">
                  ...
                  <svg onClick={handleDropdown} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
          ...
          <div className="py-4 px-6 md:px-8 w-full flex items-center justify-between">
        ...
        <div>
          <div className="pt-4 px-6 md:px-8 w-full flex items-center justify-between">
            ...
            <div className="flex items-center gap-4 justify-between">
              <span className="relative">
                <input className="py-1 pl-4 pr-8 rounded-2xl font-light text-sm border-2 border-[#D7BFDC] focus:outline-[#E4A0F7]" type="text" name="search" id="search" placeholder="type your search" />
